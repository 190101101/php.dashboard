            ...
            <ul class="navbar-nav" style="margin-right: 10px;">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="/panel/limit/5">5</a></li>
                        <li><a class="dropdown-item" href="/panel/limit/10">10</a></li>
                        <li><a class="dropdown-item" href="/panel/limit/25">25</a></li>
                        <li><a class="dropdown-item" href="/panel/limit/50">50</a></li>
                        <li><a class="dropdown-item" href="/panel/limit/100">100</a></li>
                    </ul>
                </li>
            </ul>
            <div>
